...
La plataforma permite al admininstrador:
 ...
 La actividad consiste en:
    ...
    Identificar los actores que intervienen en el sistema.
    Identificar los casos de uso principales.
    Definir las relaciones include/extend cuando sea necesario.
    Especificar extension points cuando proceda.
    Realizar un diagrama textual UML (no gráfico) que represente el sistema.
    Explicar brevemente por qué existen esas relaciones.

![Prueba UT5-A3](/img/001.png)